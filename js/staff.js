...
function init_profile_uploader()
{
    ...
    var uploader = new plupload.Uploader({
        ...
        browse_button: 'pick_image', // you can pass in id...
        container: document.getElementById('container'), // ... or DOM Element itself
        url: $("#site_url").val() + 'staff/upload_profile_pic',
        unique_names: true,
        resize: {width: 150, height: 150, quality: 100, crop : true},
        max_retries: 3,
        flash_swf_url: 'Moxie.swf',
        silverlight_xap_url: 'Moxie.xap',
        multipart_params: {
            staff_id: $("#pick_image").data("id"),
        ...
        init: {
            ...
            UploadComplete: function (up, files) {
                plupload.each(files, function (file) {
                    if($("#pick_image").data("id") > 0){
                        var src = BASE_URL + "/uploads/staff-" + $("#pick_image").data("id") + "/" + file.target_name;
                    }else{
                        var src = BASE_URL + "/uploads/temp/" + file.target_name;
                    }
...
function init_attachment_uploader()
{
    ...
    uploader_a.bind('FileUploaded', function (upldr, file, object) {
        ...
        $("#filelist_a").append("<li><a href=\"uploads/member-" + myData.member_id + "/" + myData.filename + "\" target=\"_blank\" title=\"" + myData.filename + "\"><img src=\"" + myData.icon + "\" /></a><span class=\"close remove-file\" data-file-id=\"" + myData.id + "\" title=\"Remove this file\"><i class=\"fa fa-times-circle\"></i></span></li>");
    });
